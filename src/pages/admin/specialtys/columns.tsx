...
export const columns: ColumnDef<SpecialtyProps>[] = [
  {
    accessorKey: "name",
    header: "Nome",
  },
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      const handleDelete = () => {
        fetch(`${import.meta.env.VITE_API_LINK}/specialtys/${specialty.id}`, {
          method: "DELETE",
          headers: {
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem asChild>
              <a href={`/editar/especialidade/${specialty.id}`}>Editar</a>
            </DropdownMenuItem>
