...
export const EditClinic = () => {
  ...
  const getClinic = () => {
    fetch(`${import.meta.env.VITE_API_LINK}/clinics/${id}`, {
      method: "GET",
      headers: {
  ...
  const form = useForm<z.infer<typeof clinicSchema>>({
    ...
    values: {
      ...
      mapUrl: clinic?.mapUrl as string,
    },
  });
  ...
  return (
    <main className="grow flex flex-col gap-4  items-center mt-[52px] py-8 px-[2vw] sm:px-[4vw] lg:px-[6vw]">
      <h2 className="font-bold text-3xl">Editar clínica</h2>
      ...
      <Form {...form}>
        ...
        >
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>Url no mapa:</FormLabel>
                <FormControl>
                  <Input type="text" {...field} />
                </FormControl>
                <FormMessage />
